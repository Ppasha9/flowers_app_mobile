...
import 'package:orlove_app/screens/order_formation/order_formation_payment_screen_components.dart';

class OrderFormationPaymentScreen extends StatelessWidget {
      ...
      child: Container(
        child: Column(
          children: [
            ...
            OrderFormationPaymentComponentsWidget(),
          ],
        ),
      ),
    );
