...
import 'package:orlove_app/screens/order_formation/order_formation_reveicer_screen_components.dart';

class OrderFormationReceiverScreen extends StatelessWidget {
            ...
            children: [
              ...
              Container(
                child: Divider(
                  ...
                  thickness: 5.0,
                  indent: 30.0,
                  endIndent: mediaQuery.size.width - 45.0,
                ),
              ),
            ],
          ),
      ...
      child: Container(
        child: Column(
          children: [
            ...
            OrderFormationReceiverContentWidget(),
          ],
        ),
      ),
    );
